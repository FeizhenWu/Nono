...
#Supplementary Figure2 ABC 1st column
{
  ...
  myGroup=WT_KO$data[WT_KO$data$group=="F"|WT_KO$data$group=="I",]
  genes=row.names(myGroup)
  RE1=RE
  RE1$exp=RE1$exp[RE1$exp$geneSymbol %in%genes, ]
  KO1=KO
  KO1$exp=KO1$exp[KO1$exp$geneSymbol %in%genes, ]
  groupFI=Nine_Square(RE1,KO1,myXlabel="log2(D3/D0) in NonoKO+WT",myYlabel="log2(D3/D0) in NonoKO",org="mmu")
  groupFI$nineSquare
  ...
  KO1=KO
  KO1$exp=KO1$exp[KO1$exp$geneSymbol %in%genes, ]
  groupAD=Nine_Square(RE1,KO1,myXlabel="log2(D3/D0) in NonoKO+WT",myYlabel="log2(D3/D0) in NonoKO",org="mmu")
  groupAD$nineSquare
}

#Supplementary Figure2 ABC 2nd column
{
  ...
  KO1=KO
  KO1$exp=KO1$exp[KO1$exp$geneSymbol %in%genes, ]
  groupFI=Nine_Square(RE1,KO1,myXlabel="log2(D6/D3) in NonoKO+WT",myYlabel="log2(D6/D3) in NonoKO",org="mmu")
  groupFI$nineSquare
  ...
  KO1=KO
  KO1$exp=KO1$exp[KO1$exp$geneSymbol %in%genes, ]
  groupAD=Nine_Square(RE1,KO1,myXlabel="log2(D6/D3) in NonoKO+WT",myYlabel="log2(D6/D3) in NonoKO",org="mmu")
  groupAD$nineSquare
}

#Supplementary Figure2 ABC 3rd column
{
  ...
  KO1=KO
  KO1$exp=KO1$exp[KO1$exp$geneSymbol %in%genes, ]
  groupFI=Nine_Square(RE1,KO1,myXlabel="log2(D12/D6) in NonoKO+WT",myYlabel="log2(D12/D6) in NonoKO",org="mmu")
  groupFI$nineSquare
  ...
  KO1=KO
  KO1$exp=KO1$exp[KO1$exp$geneSymbol %in%genes, ]
  groupAD=Nine_Square(RE1,KO1,myXlabel="log2(D12/D6) in NonoKO+WT",myYlabel="log2(D12/D6) in NonoKO",org="mmu")
  groupAD$nineSquare
}
